"""
Simple test to check environment variables without external dependencies
"""
...
def test_environment():
    ...
    try:
        ...
        print("Run: pip install requests python-dotenv supabase")
        return False
